...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviecomplexofficiagroup)
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mc_adzz')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Moviecomplexadminbot')
